...
class UsersURLTests(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='serg')
    ...
    def test_urls_response_guest(self):
        ...
        url_status = {
            ...
            reverse('users:password_reset_confirm',
                    kwargs={
                        'uidb64': 'NA', 'token': '4h5-jahsgfj124124jhgwfqdy3'
                    }): HTTPStatus.OK,
            reverse('users:reset_password_complete'): HTTPStatus.OK,
        }
    ...
    def test_urls_uses_correct_template(self):
        ...
        templates_pages_names = {
            ...
            reverse('users:reset_password_complete'):
