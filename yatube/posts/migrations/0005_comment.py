# Generated by Django 2.2.16 on 2022-12-10 10:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='Текст сообщения', verbose_name='Текст комментария')),
                ...
                ('post', models.ForeignKey(help_text='Сообщение для комментариев', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.Post', verbose_name='Сообщение для комментариев')),
            ],
            options={
